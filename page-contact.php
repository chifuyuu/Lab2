        ...
        <section class="section gb nopadtop">
            <div class="container">
                <div class="boxed boxedp4">
					<div class="gmap_canvas"><iframe width="1050" height="350" id="gmap_canvas" src="https://maps.google.com/maps?q=gatchalian&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.embedgooglemap.net/blog/20-off-discount-for-elegant-themes-divi-sale-coupon-code-2019/">divi by elegant themes</a></div><style>.mapouter{position:relative;text-align:right;height:350px;width:1050px;}.gmap_canvas {overflow:hidden;background:none!important;height:350px;width:1050px;}</style>                    
					<div class="row contactv2 text-center">
                        <div class="col-md-4">
                            <div class="small-box">
                                <i class="flaticon-email wow fadeIn"></i>
                                <h4>Contact us today</h4>
                                <small>Phone: +98 765 432 1</small>
                                <p><a href="mail:to">paulragsac.@gmail.com</a></p>
                            </div><!-- end small-box -->
                        </div><!-- end col -->
                        ...
                        <div class="col-md-4">
                            <div class="small-box">
                                ...
                                <h4>Visit Us</h4>
                                <small>425, Lawin St. Gatchalian Subd.</small>
                                <small>Brgy. Manuyo Dos Las Pinas City</small>
                                <p><a href="https://www.google.com/maps/@14.4739521,120.9946953,21z">View on Google Map</a></p>
                            </div><!-- end small-box -->
                        </div><!-- end col -->
                        ...
                        <div class="col-md-4">
                            <div class="small-box">
                                ...
                                <h4>Be Social</h4>
                                <small>Facebook: facebook.com/Lolicon.Knight</small>
                            </div><!-- end small-box -->
                        </div><!-- end col -->
                    </div><!-- end contactv2 -->
